...
import com.cjy.qiquan.mail.transport.EmailTransportException;
import com.cjy.qiquan.mail.transport.PostalService;
import com.cjy.qiquan.mail.validation.EmailAddressValidator;
import com.cjy.qiquan.mail.validation.IncompleteEmailException;
import com.cjy.qiquan.mail.validation.InvalidEmailAddressException;
...
public class EmailMessage implements EmailBuilder, Email {
	...
	public EmailBuilder withAttachment(List<String> attachments) {
 		for (int i = 0; i < attachments.size(); i++) {
			this.attachments.add(attachments.get(i));
		}
		return this;
	}
