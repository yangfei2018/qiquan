...
public class ImageItem {
	...
	public ImageItem(byte[] content) throws RestApiException {
		this(Constant.UPLOAD_MODE, content);
	}

	public ImageItem(String name, byte[] content) throws RestApiException {
		String imgtype = null;
		try {
