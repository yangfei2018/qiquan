							...
							<div class="tabs-container">
								<ul class="nav nav-tabs">
									<li <c:if test="${status==-1 }">class="active"</c:if>><a
										href="partner/orderlist/${id}?status=-1"> 全部</a></li>
									<li <c:if test="${status==0 }">class="active"</c:if>><a
										href="partner/orderlist/${id}?status=0"> 待成交</a></li>
									<li <c:if test="${status==1 }">class="active"</c:if>><a
										href="partner/orderlist/${id}?status=1"> 已成交</a></li>
									<li <c:if test="${status==2 }">class="active"</c:if>><a
										href="partner/orderlist/${id}?status=2"> 平仓记录</a></li>
									<li <c:if test="${status==3 }">class="active"</c:if>><a
										href="partner/orderlist/${id}?status=3"> 已结算</a></li>
								</ul>
