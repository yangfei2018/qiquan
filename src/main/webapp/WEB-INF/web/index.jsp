						...
						<input type="hidden" name="loginMethod" value="1" />
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									name="validateCode" value="" tabIndex="3">
								</div>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									...
									class="btn btn-primary radius btn-block" type="button">登录</button>
								</div>
							</div>
						</form>
						...
						<form class="form-horizontal" style="display: none">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									class="form-control" tabIndex="2" autofocus="autofocus">
								</div>
							</div>
